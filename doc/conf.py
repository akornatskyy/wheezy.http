# -*- coding: utf-8 -*-
#
# wheezy.http documentation build configuration file, created by
...
htmlhelp_basename = 'wheezy.httpdoc'
...
latex_documents = [
  ('index', 'wheezy.http.tex', u'wheezy.http Documentation',
...
man_pages = [
    ('index', 'wheezy.http', u'wheezy.http Documentation',
